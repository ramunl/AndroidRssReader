...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	protected void init(Context context) {
		...
		mRefreshImage = (ImageView) mRefreshView
				.findViewById(R.id.pull_to_refresh_image);
		mRefreshProgress = (ProgressBar) mRefreshView
	...
	private void resetHeader() {
		if (mRefreshState != TAP_TO_REFRESH) {
			...
			mRefreshImage.setImageResource(R.drawable.ic_pulltorefresh_arrow);
		...
		if (mCurrentScrollState == SCROLL_STATE_TOUCH_SCROLL
			...
			if (firstVisibleItem == 0) {
				...
				if ((mRefreshView.getBottom() >= mRefreshViewHeight + 20 || mRefreshView
					...
					mRefreshImage.clearAnimation();
					mRefreshImage.startAnimation(mFlipAnimation);
					...
					if (mRefreshState != TAP_TO_REFRESH) {
						mRefreshImage.clearAnimation();
						mRefreshImage.startAnimation(mReverseFlipAnimation);
					}
					mRefreshState = PULL_TO_REFRESH;
				}
			} else {
	...
	public void prepareForRefresh() {
		...
		mRefreshImage.setImageDrawable(null);
